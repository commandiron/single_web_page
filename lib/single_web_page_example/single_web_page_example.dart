...
import 'package:single_web_page/single_web_page_example/sections.dart';
          ...
          children: [
            Expanded(
              child: Container(
                ...
                child: Row(
                  children: Section.sections.asMap().entries.map(
                        (e) => MenuButton(onPressed: () => _controller.animateToSectionIndex(e.key),text: e.value.title),
                  ).toList(),
                ),
              ),
            ),
                    ...
                    return FittedBox(
                      child: Row(
                        children: [
                          ...
                          Icon(Icons.flutter_dash, color: Theme.of(context).colorScheme.onPrimary, size: 40,)
                        ],
                      ),
                    );
                  },
